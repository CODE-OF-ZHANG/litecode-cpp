...
constexpr const char* kAllKeys[] = {
    ...
    "RATE_LIMIT_RANKING_PER_MIN",
    "RATE_LIMIT_ADMIN_USERS_LIST_PER_MIN",
    "RATE_LIMIT_ADMIN_USERS_ROLE_PER_MIN",
    "RATE_LIMIT_ADMIN_AUDIT_LOGS_PER_MIN",
    "RATE_LIMIT_ADMIN_QUEUE_PER_MIN",
    "LOGIN_LOCKOUT_ENABLED", "LOGIN_LOCKOUT_THRESHOLD",
    "LOGIN_LOCKOUT_WINDOW_SECONDS", "LOGIN_LOCKOUT_DURATION_SECONDS",
    "COOKIE_ENABLED", "COOKIE_HTTP_ONLY", "COOKIE_SECURE", "COOKIE_SAME_SITE",
    "COOKIE_PATH", "COOKIE_NAME", "COOKIE_MAX_AGE_SECONDS",
    "COOKIE_ALLOW_BODY_FALLBACK",
